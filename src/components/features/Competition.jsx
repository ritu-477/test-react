            ...
            <div className="table-responsive">
              <table className="custom-table-bg py-5">
                <thead>
                  <tr>
                    <th></th>
                    <th className="radius-top fw-semibold text-center bg-white table-heading text-black">Rift</th>
                    <th className="radius-top fw-semibold text-center bg-white table-heading text-black">Taxscout</th>
                    <th className="radius-top fw-semibold text-center bg-white table-heading text-black">Coconut</th>
                    <th className="radius-top fw-semibold text-center bg-dark-aqua table-heading text-black">Pie</th>
                  </tr>
                </thead>
                <tbody>
